    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex justify-evenly">
          <button className="w-[200px] m-5 rounded transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 bg-cyan-500 shadow-lg shadow-cyan-500/50 text-[#ffff]">Đăng xuất</button>
        </div>
      </div>
    </div>
  );
